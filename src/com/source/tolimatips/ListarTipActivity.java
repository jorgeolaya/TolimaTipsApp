...
public class ListarTipActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			new HttpTask().execute("http://181.51.33.41/WS/public/tip/")
					.get();
		} catch (Exception e) {
		...
		lista.setAdapter(new Lista_Tips_Adaptador(ListarTipActivity.this,R.layout.activity_listatips,tips));
		...
		lista.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				Intent act = new Intent(ListarTipActivity.this,TipActivity.class);
	...
	public void home(View view) {
		Intent act = new Intent(ListarTipActivity.this, MainActivity.class);
